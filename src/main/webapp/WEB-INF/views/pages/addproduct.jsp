...
<body>
	<section class="container" style="position: absolute-center; background-color: lightblue; align-items: center;">
			<form:form name="addForm" modelAttribute="productToAdd"
				class="form-horizontal" method="post" action="${pageContext.request.contextPath}/adminpanel/addproduct">
				<fieldset>
					<legend>
